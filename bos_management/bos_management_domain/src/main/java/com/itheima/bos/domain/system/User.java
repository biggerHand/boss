...
public class User {
    ...
    public String toString() {
        return "User [id=" + id + ", birthday=" + birthday + ", gender=" + gender + ", password="
                + password + ", remark=" + remark + ", station=" + station + ", telephone="
                + telephone + ", username=" + username + ", nickname=" + nickname + ", roles="
                + roles + "]";
    }
